    ...
    <main>
      <>
        ...
        <Section>
          <Container>
          <Column>
            <ImageWrap style={{ maxWidth: '100%', height: 'auto' }}>
              <Image alt="Description of the image">
                <img src="https://cdn.discordapp.com/attachments/1051281685234327613/1119301973531959476/download_3.png" alt="Description of the image" style={{ maxWidth: '100%', height: 'auto' }} />
              </Image>
            </ImageWrap>
          </Column>
            <Column>
